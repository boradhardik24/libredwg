...
#undef DWG_ENTITY
#undef DWG_OBJECT
#define FREE_NOCLASS(name) case DWG_TYPE_##name: return dwg_free_##name (dat, obj);
...
int dwg_free_subent (Bit_Chain *dat, Bit_Chain *hdl_dat, Bit_Chain *str_dat,
                       Dwg_Object *restrict obj)
{
...
#define DISPATCH_TYPE(name) \
  case DWG_TYPE_##name: return dwg_free_##name##_impl (dat, hdl_dat, str_dat, obj);
